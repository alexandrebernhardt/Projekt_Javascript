...
// Database connection
var mySQLCredentials = mysql.createPool({
		connectionLimit : 1,
		host: 'localhost',
		user: 'rootusr',
		password: 'rootpsswd',
...
// Select requests
var selectAllData = 'SELECT temperature, background_color, access_status, purchase_date, insurance_end, failures_start FROM data';
